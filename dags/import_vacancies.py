...
with DAG(dag_id = "import_vacancies_materialized_postgre_engine", schedule_interval = None,
   default_args = default_args, catchup = False) as dag:
        
   import_all = PythonVirtualenvOperator(task_id = "import_vacancies_materialized_postgre_engine", requirements=["clickhouse-driver"],
